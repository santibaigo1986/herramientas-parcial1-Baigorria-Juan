...
namespace BaigorriaJuan.Controllers
{
    public class PublisherController : Controller
    {
        ...
        public PublisherController(BooksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publisher != null ? 
                          ...
                          Problem("Entity set 'BooksContext.Publisher'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BooksContext.Publisher'  is null.");
            }
            var publisher = await _context.Publisher.FindAsync(id);
            if (publisher != null)
            {
